...
namespace App\Filament\Resources\SdQuizResource\Widgets;

use App\Models\SdScore;
use Filament\Widgets\StatsOverviewWidget as BaseWidget;
use Filament\Widgets\StatsOverviewWidget\Stat;

class Result extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $totalPengumpulan = SdScore::where('sd_quiz_id', $quizId)->count();
        $nilaiTertinggi = SdScore::where('sd_quiz_id', $quizId)->max('score') ?? 0;
